...
Min-Entropy: 7.98-7.99 bits/byte across all configurations (NIST SP 800-90B validated)
...
TechnologyMin-Entropy (bits/byte)SpeedCostHardware RequiredAir-Gap CompatibleSQEF7.98-7.99273 MB/sSoftware LicenseStandard CPU or No specialized hardwareYesHardware QRNG~7.99100 MB/s - 3 GB/s$10,000-$100,000Quantum DeviceYesCloud Quantum (Quantinuum)~7.99Network LimitedSubscriptionInternet + Remote QCNoIntel RDRAND~7.90-7.95500 MB/s - 3 GB/sBuilt-inIntel CPU onlyYesLinux /dev/urandom~7.90-7.95500 MB/sFreeStandard CPUYesTPM 2.0~7.85-7.901-10 MB/s$50-$200TPM ChipYes
...
Min-Entropy: 7.98-7.99 bits/byte (exceeds ≥7.976 threshold)
...
Superior min-entropy - 7.98-7.99 vs. ~7.90-7.95 bits/byte
